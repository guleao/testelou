    ...
    <div ref={ref}>
      <Box
        sx={{
          ...
          marginTop: "50px",
          width: "100%",
          marginLeft: isMobile || isLargeScreen ? 0 : "8px",
        }}
      >
        <img
          src={
            isMobile
              ? "./img/Pizza_derretendoMob.png"
              : "./img/Pizza_derretendo.png"
          }
          alt="Pizza"
          style={{
            width: "100%",
            maxWidth: isLargeScreen ? "530px" : "600px",
        ...
        <Box sx={{ textAlign: "left" }}>
          ...
          <Typography
            ...
            sx={{ fontWeight: "bold", marginLeft: isMobile ? 0 : "15px" }}
          >
            <Box>A melhor pizza com o melhor </Box>
            <Box>atendimento da cidade!</Box>
          </Typography>
          <List sx={{ marginTop: isLargeScreen ? "-10px" : "45px" }}>
              ...
              >
                <Box
                  sx={{
                    ...
                    justifyContent: "center",
                    alignItems: "center",
                    boxShadow: "0px 10px 10px -3px rgba(0, 0, 0, 0.25)",
                ...
                <ListItemText
                  ...
                  secondary={
                    ...
                    >
                      ...
                      gravid eu egestas sed quis donec ipsum eu. In viverra
                      velit.
                    </Typography>
                  }
                />

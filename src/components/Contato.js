    ...
    <div ref={ref}>
      ...
      >
        <Typography
          ...
          sx={{ color: "#FF5000", fontWeight: "bold" }}
        >
          Entre em contato
        </Typography>
        <Typography
        ...
        >
          {isMobile ? (
            <>
              <Box>
                Se desejar alguma informação ou efetuar uma compra com nossos
                atendentes
              </Box>
            </>
          ) : (
        ...
        >
          {isMobile ? (
            ...
            <>
              <Box>
                Lorem ipsum dolor sit amet consectetur. Platea viverra nam vitae
                convallis. Orci fringilla imperdiet
              </Box>
